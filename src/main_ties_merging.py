...
exam_datasets = ['Cars', 'RESISC45', 'EuroSAT', 'GTSRB']
# EuroSAT, RESISC45
# exam_datasets =  ['EuroSAT', 'RESISC45']

# exam_datasets =  ['MNIST', 'EuroSAT']



# exam_datasets =  ['SVHN', 'RESISC45']
# exam_datasets =  ['SVHN', 'EuroSAT']


model = 'ViT-B-32'
args = parse_arguments()
# args.data_location = '/media/brcao/eData4TB05/brcao/Data/datasets/mm/'
# args.model = model
# args.save = 'checkpoints/' + model
# args.logs_path = 'logs/' + model
# pretrained_checkpoint = '/media/brcao/eData4TB05/ranjith/NAFNet/models/task_vectors_checkpoints/ViT-B-32/zeroshot.pt'
...
ft_checks = [torch.load('/home/brcao/Repos/merge_model/Datasets/models/task_vectors_checkpoints/ViT-B-32'+'/'+dataset_name+'/finetuned.pt').state_dict() for dataset_name in exam_datasets]
